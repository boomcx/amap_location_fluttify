...
Future<bool> AmapLocationFluttifyIOSIs<T>(dynamic __this__) async {
  ...
  if (RegExp(
    ...
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapGeoFenceManager',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapLocationRegion) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapLocationRegion',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapLocationCircleRegion) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapLocationCircleRegion',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapLocationPolygonRegion) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapLocationPolygonRegion',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapGeoFenceRegion) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapGeoFenceRegion',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapGeoFenceCircleRegion) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapGeoFenceCircleRegion',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapGeoFencePolygonRegion) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapGeoFencePolygonRegion',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapGeoFencePOIRegion) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapGeoFencePOIRegion',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapGeoFenceDistrictRegion) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapGeoFenceDistrictRegion',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapLocationManager) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapLocationManager',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapLocationReGeocode) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapLocationReGeocode',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapLocationPoint) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapLocationPoint',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapLocationPOIItem) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapLocationPOIItem',
      {'__this__': __this__},
    );
    return result;
  } else if (T == AMapLocationDistrictItem) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfAMapLocationDistrictItem',
      {'__this__': __this__},
    );
    return result;
  } else if (T == CLLocation) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfCLLocation',
      {'__this__': __this__},
    );
    return result;
  } else if (T == CLHeading) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfCLHeading',
      {'__this__': __this__},
    );
    return result;
  } else if (T == CGRect) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfCGRect',
      {'__this__': __this__},
    );
    return result;
  } else if (T == CGPoint) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfCGPoint',
      {'__this__': __this__},
    );
    return result;
  } else if (T == CGSize) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfCGSize',
      {'__this__': __this__},
    );
    return result;
  } else if (T == UIEdgeInsets) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfUIEdgeInsets',
      {'__this__': __this__},
    );
    return result;
  } else if (T == CLLocationCoordinate2D) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfCLLocationCoordinate2D',
      {'__this__': __this__},
    );
    return result;
  } else if (T == CLLocationManager) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfCLLocationManager',
      {'__this__': __this__},
    );
    return result;
  } else if (T == NSError) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfNSError',
      {'__this__': __this__},
    );
    return result;
  } else if (T == NSCoding) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfNSCoding',
      {'__this__': __this__},
    );
    return result;
  } else if (T == NSCopying) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfNSCopying',
      {'__this__': __this__},
    );
    return result;
  } else if (T == UIView) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfUIView',
      {'__this__': __this__},
    );
    return result;
  } else if (T == UIViewController) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfUIViewController',
      {'__this__': __this__},
    );
    return result;
  } else if (T == UIControl) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfUIControl',
      {'__this__': __this__},
    );
    return result;
  } else if (T == UIImage) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfUIImage',
      {'__this__': __this__},
    );
    return result;
  } else if (T == UIColor) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfUIColor',
      {'__this__': __this__},
    );
    return result;
  } else if (T == NSData) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfNSData',
      {'__this__': __this__},
    );
    return result;
  } else if (T == NSOperation) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfNSOperation',
      {'__this__': __this__},
    );
    return result;
  }
