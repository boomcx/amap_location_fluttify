...
Future<bool?> AmapLocationFluttifyAndroidIs<T>(dynamic __this__) async {
  ...
  if (RegExp(
    ...
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_location_AMapLocationClient',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_location_APSService) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_location_APSService',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_location_DPoint) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_location_DPoint',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_location_CoordinateConverter) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_location_CoordinateConverter',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_location_CoordUtil) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_location_CoordUtil',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_location_UmidtokenInfo) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_location_UmidtokenInfo',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_location_AMapLocation) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_location_AMapLocation',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_location_AMapLocationClientOption) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_location_AMapLocationClientOption',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_location_AMapLocationQualityReport) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_location_AMapLocationQualityReport',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_fence_DistrictItem) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_fence_DistrictItem',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_fence_GeoFenceClient) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_fence_GeoFenceClient',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_fence_GeoFence) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_fence_GeoFence',
      {'__this__': __this__},
    );
    return result;
  } else if (T == com_amap_api_fence_PoiItem) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfcom_amap_api_fence_PoiItem',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_content_Context) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_content_Context',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_content_Intent) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_content_Intent',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_content_ContentProvider) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_content_ContentProvider',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_app_Application) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_app_Application',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_app_Notification) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_app_Notification',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_app_Activity) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_app_Activity',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_app_PendingIntent) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_app_PendingIntent',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_os_Bundle) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_os_Bundle',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_os_Binder) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_os_Binder',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_view_View) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_view_View',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_view_SurfaceView) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_view_SurfaceView',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_view_ViewGroup) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_view_ViewGroup',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_graphics_Point) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_graphics_Point',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_graphics_PointF) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_graphics_PointF',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_graphics_Bitmap) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_graphics_Bitmap',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_widget_ImageView) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_widget_ImageView',
      {'__this__': __this__},
    );
    return result;
  } else if (T == java_io_File) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfjava_io_File',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_location_Location) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_location_Location',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_view_MotionEvent) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_view_MotionEvent',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_graphics_drawable_Drawable) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_graphics_drawable_Drawable',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_widget_FrameLayout) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_widget_FrameLayout',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_widget_TextView) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_widget_TextView',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_widget_LinearLayout) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_widget_LinearLayout',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_widget_RelativeLayout) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_widget_RelativeLayout',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_os_Parcelable) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_os_Parcelable',
      {'__this__': __this__},
    );
    return result;
  } else if (T == android_util_Pair) {
    final result = await kAmapLocationFluttifyChannel.invokeMethod(
      'RefClass::isKindOfandroid_util_Pair',
      {'__this__': __this__},
    );
    return result;
  }
